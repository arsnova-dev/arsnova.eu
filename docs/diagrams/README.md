...
| Datei | Inhalt |
|-------|--------|
| `diagrams.md` | Backend-, Frontend-, DB-Schema, Kommunikation Dozent/Student/**Admin**, Aktivität inkl. Admin (Stand: 2026-03-14) |
| `architecture-overview.md` | System-Architektur, Datenfluss inkl. Admin, Komponenten-Hierarchie inkl. Admin, Sicherheit inkl. Rollen-Autorisierung (Stand: 2026-03-14) |
